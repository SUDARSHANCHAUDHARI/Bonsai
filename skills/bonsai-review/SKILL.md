...
description: >
  ...
  delete", "is this over-engineered", "trim review", or invokes /bonsai-review.
...
self-check is the bonsai minimum, not bloat; never flag it for deletion. Does
not apply the fixes, only lists them. "stop bonsai-review" or "normal mode":
